      ...
      <Container>
        ...
        <TableContainer component={Paper} className="product-table">
          <Table>
            <TableHead>
              <TableRow>
                <TableCell>Name</TableCell><TableCell>Price</TableCell><TableCell>Discount</TableCell>
                <TableCell>Category</TableCell><TableCell>Stock</TableCell><TableCell>Brand</TableCell>
                <TableCell>Featured</TableCell><TableCell>Image</TableCell><TableCell>Actions</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {filteredProducts.map((prod) => (
                <TableRow key={prod._id}>
                  ...
                  <TableCell>{prod.prodPrice}</TableCell>
                  ...
                  <TableCell>
                    <img src={`http://localhost:5002/uploads/${prod.prodImage}`} alt="prod" width="40" />
                  </TableCell>
                  <TableCell>
